...
var Tasks = function (props) {
    ...
    var getActualData = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log(props);
                    return [4 /*yield*/, getTasksdata(props)];
                case 1:
                    actualData = _a.sent();
                    setData(actualData);
                    return [2 /*return*/];
    ...
    return (React.createElement("div", { className: 'inCard bg-gradient-4' },
        ...
        React.createElement("div", { className: 'row1 inCard--body' },
            React.createElement("ul", { className: 'bullents round' }, data === null || data === void 0 ? void 0 : data.map(function (x, i) {
                    ...
                    React.createElement("li", null,
                        React.createElement("div", { className: 'inCard-list' },
                            ...
                            React.createElement("a", { href: "https://zelarsoft1.sharepoint.com/sites/Zelardemo/learningmanagement/Lists/Tasks/DispForm.aspx?ID=".concat(x.ID), target: '_blank' },
                                React.createElement(FiEye, { size: "25px", color: 'white' })))));
            }))),
