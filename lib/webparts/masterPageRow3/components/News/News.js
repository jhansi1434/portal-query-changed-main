...
var News = function (props) {
    ...
    var getActualData = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log(props);
                    return [4 /*yield*/, getNewsData(props)];
                case 1:
                    actualData = _a.sent();
                    setData(actualData);
                    return [2 /*return*/];
    ...
    return (React.createElement("div", { className: 'inCard1 bg-gradient-two' },
        ...
        React.createElement("div", { className: 'row1 inCard1--body' },
            React.createElement("ul", { className: 'bullets round1' }, data === null || data === void 0 ? void 0 : data.map(function (x, i) {
                return (i < 3 &&
                    React.createElement("li", null, x.Title));
            }))),
        React.createElement("div", { className: ((_a = props.data) === null || _a === void 0 ? void 0 : _a.length) > 3 ? 'inCard1--Footer1' : 'nofooter' },
