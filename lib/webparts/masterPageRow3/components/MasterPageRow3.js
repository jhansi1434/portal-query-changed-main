...
var MasterPageRow3 = function (props) {
    ...
    return (React.createElement("div", { className: "mainContainer" },
        React.createElement("div", { className: 'Containers3' },
            React.createElement("div", { className: 'opinionpoll' },
                React.createElement(OpinionPoll, { data: props })),
            React.createElement("div", null,
                React.createElement(News, { data: props })))));
};
