...
var Opinionpoll = function (props) {
    ...
    var getData = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getOpinionPollData(props)];
                case 1:
                    actualData = _a.sent();
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: 'inCard1 bg-gradient-one' },
            React.createElement("div", { className: 'inCard1--header' },
                React.createElement("p", { className: 'inCard1--header one' }, "Today's"),
                React.createElement("p", { className: 'inCard1--header two' },
                    React.createElement("b", null, "Opinion Poll"))),
            React.createElement("div", { className: 'row32 inCard--body' }, pollData && (pollData === null || pollData === void 0 ? void 0 : pollData.map(function (x) {
                return (React.createElement(React.Fragment, null,
                    React.createElement(PollElement, { data: x, context: props.context })));
            }))))));
};
