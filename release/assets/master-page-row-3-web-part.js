...
var PollElement = function (props) {
    ...
    var checkUser = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _sp = Object(_pnpConfig__WEBPACK_IMPORTED_MODULE_3__["getSP"])(props.context);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: 'PoleClass' },
...
// Module
exports.push([module.i, ".PoleClass h1{font-size:18px;margin:16px 1px;padding-top:2px}._1xGEd{-ms-flex-align:start;align-items:flex-start}", ""]);
...
var Opinionpoll = function (props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null,
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: 'inCard1 bg-gradient-one' },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: 'row32 inCard--body' },
...
/*!**********************************!*\
  ...
  \**********************************/
/*! exports provided: getAnnouncementsData, getBirthdayData, getTrainingsdata, getTasksdata, getNewsData, getOpinionPollData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                spHttpClient = props.data.spHttpClient;
                endpointUrl = "".concat(siteUrl, "/_api/web/lists/getbytitle('").concat(listName, "')/items?$select=ID,Q.Id,Q.Name,Q.Choices&$filter=Active eq 1");
                console.log(endpointUrl);
                return [4 /*yield*/, spHttpClient.get(endpointUrl, _microsoft_sp_http_base__WEBPACK_IMPORTED_MODULE_0__["SPHttpClient"].configurations.v1)
                        .then(function (response) {
                        if (response.ok) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "mainContainer" },
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: 'Containers3' },
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: 'opinionpoll' },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_Opinion_Poll__WEBPACK_IMPORTED_MODULE_2__["default"], { description: props.description, isDarkTheme: props.isDarkTheme, environmentMessage: props.environmentMessage, hasTeamsContext: props.hasTeamsContext, userDisplayName: props.userDisplayName, context: props.context })),
